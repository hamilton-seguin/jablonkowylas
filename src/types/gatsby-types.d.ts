...
type GalleryRenderQueryQueryVariables = Exact<{ [key: string]: never; }>;


type GalleryRenderQueryQuery = { readonly allFile: { readonly edges: ReadonlyArray<{ readonly node: { readonly name: string, readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } }> } };
